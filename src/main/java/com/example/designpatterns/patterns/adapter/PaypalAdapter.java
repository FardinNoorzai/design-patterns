...
public class PaypalAdapter implements PaymentGateway {
    Logger logger = LoggerFactory.getLogger(PaypalAdapter.class);
    @Override
    public PaymentResult charge(String cardNumber, BigDecimal amount) {
        logger.info("Charging Card Number using paypal client internal logic: {} amount {}", cardNumber,amount.toString());
    ...
    public RefundResult refund(String cardNumber, BigDecimal amount) {
        logger.info("Refunding Card Number using paypal client internal logic: {} amount {}", cardNumber,amount.toString());
